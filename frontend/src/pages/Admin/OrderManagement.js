  ...
  const handleConfirmOrder = async (orderId, totalAmount) => {
    try {
      if (totalAmount > 500000) {
        handleAlert(
          "Không hỗ trợ thu tiền hộ với đơn hàng lớn hơn 500,000 VNĐ",
          "warning"
        );
        return;
      }
  ...
  return (
    ...
    >
      <Box sx={{ display: "flex", alignItems: "center", mb: 3, gap: 2 }}>
        <ReceiptLong sx={{ fontSize: 40, color: "#2c3e50" }} />
        <Typography
          variant="h4"
          sx={{
            fontWeight: 700,
      ...
      >
        <FormControl variant="outlined" sx={{ minWidth: 250 }}>
          <InputLabel>
            <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
              <FilterIcon fontSize="small" /> Trạng thái đơn hàng
            </Box>
          </InputLabel>
          <Select
            value={filterStatus}
        ...
        <FormControl variant="outlined" sx={{ minWidth: 250 }}>
          <InputLabel>
            <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
              <SortIcon fontSize="small" /> Sắp xếp theo ngày
            </Box>
          </InputLabel>
          <Select
            value={sortOrder}
          ...
          <TableHead sx={{ backgroundColor: "#2c3e50" }}>
            <TableRow>
              <TableCell sx={{ color: "#fff", fontWeight: 700 }}>
                <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                  <PersonIcon fontSize="small" /> Khách hàng
                </Box>
              </TableCell>
              <TableCell sx={{ color: "#fff", fontWeight: 700 }}>
                <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
              ...
              <TableCell sx={{ color: "#fff", fontWeight: 700 }}>
                <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                  <PaymentIcon fontSize="small" /> Phương thức
                </Box>
              </TableCell>
              <TableCell sx={{ color: "#fff", fontWeight: 700 }}>
                <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                  <PaymentIcon fontSize="small" /> TT thanh toán
                </Box>
              </TableCell>
              <TableCell sx={{ color: "#fff", fontWeight: 700 }}>
                <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
              ...
              <TableCell sx={{ color: "#fff", fontWeight: 700 }}>
                <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                  <InfoIcon fontSize="small" /> Trạng thái đơn hàng
                </Box>
              </TableCell>
              <TableCell sx={{ color: "#fff", fontWeight: 700 }}>
                <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                  <BoxIcon fontSize="small" /> Thông tin vận chuyển
                </Box>
              </TableCell>
              <TableCell sx={{ color: "#fff", fontWeight: 700 }}>
                Thao tác
